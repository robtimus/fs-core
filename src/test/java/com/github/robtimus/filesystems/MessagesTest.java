...
public class MessagesTest {
    ...
    public MessagesTest(@SuppressWarnings("unused") String testName, Method method, Object target) {
        this.method = method;
        this.target = target;
    }
    ...
    public static Iterable<Object[]> getParameters() {
        ...
        collectParameters(parameters, Messages.class, null, "Messages");
        return parameters;
    }
    ...
    private static void collectParameters(List<Object[]> parameters, Class<?> cls, Object instance, String path) {
        for (Method method : cls.getMethods()) {
            if (method.getDeclaringClass() != Object.class) {
                ...
                if (returnType.getDeclaringClass() == Messages.class) {
